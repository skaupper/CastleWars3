...
void MainMenu::setup()
{
    addElement<Element>("background").addAnimation<Animation>().addTexture(Texture("bg.png"));

    Element &overlay = addElement<Element>("overlay");
    overlay.addAnimation<Animation>("startgame").addTexture(Texture("startgame.png"));
